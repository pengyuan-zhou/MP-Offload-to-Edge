package helsinki.semanticSlam.slamar;
...
import helsinki.semanticSlam.rendering.gles.Sphere3D;
import helsinki.semanticSlam.utils.Logger;
...
public class NativeHelper {
    ...
    public int processCameraFrame(long matAddrGr, long matAddrRgba, PointCor[] pointcors){
        //Log.d("JNI_", "processCameraFrame: new image");
        nativeProcessFrameMat(matAddrGr,matAddrRgba,pointcors);
    ...
    private native void nativeProcessFrameMat(long matAddrGr, long matAddrRgba, PointCor[] pointcors);
